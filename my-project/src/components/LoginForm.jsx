function LoginForm() {
    return (
        <div className="h-screen p-8 flex flex-col border justify-center">
            <div>
                <h1 className="font-semibold text-xl">Welcome</h1>
                <h4>Please enter your details!</h4>
            </div>            
            <div className="mt-4">
                <button className="w-full border rounded-md p-1 cursor-pointer">Login with Google</button>
            </div>
            <div className="mt-8">
                ...
                <div className="mt-8">
                    <button className="w-full bg-black text-white rounded-md p-1 cursor-pointer">Log In</button>
                    <div className="flex mt-4">
                        <p>Don't have an account?</p>
                        <a className="ml-2 font-semibold underline" href="signup">Sign up</a>
                    </div>
                </div>
            </div>
